...
export default function Section1() {
  // Tipamos explícitamente con "Variants" de framer-motion
  ...
  const itemVariants: Variants = {
    ...
    show: { 
      ...
      transition: { 
        duration: 1.2, 
        // Le indicamos a TS que es una tupla exacta de 4 números
    ...
    <section className="relative h-[calc(100vh-96px)] w-full flex flex-col items-center justify-center text-center overflow-hidden bg-neutral-950">
      ...
      >
        <motion.h2 
          ...
          className="font-outfit text-amber-500/90 tracking-[0.4em] md:tracking-[0.6em] uppercase text-[10px] md:text-xs mb-8 md:mb-10"
        >
        ...
        >
          ...
          <span className="italic font-light text-stone-200">D'Orazio</span>
        </motion.h1>

        {/* Línea divisoria que crece */}
        <motion.div 
          variants={{
            hidden: { width: 0, opacity: 0 },
            show: { width: "4rem", opacity: 1, transition: { duration: 1.5, ease: "circOut" } }
          }}
          className="h-[1px] bg-amber-500 mb-8 md:mb-10"
        ></motion.div>
